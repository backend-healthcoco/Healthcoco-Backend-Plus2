...
public class DentalLabServiceAssociationLookupResponse {
	...
	public String toString() {
		return "DentalLabServiceAssociationLookupResponse [id=" + id + ", dentalImagingServiceId="
				+ dentalImagingServiceId + ", locationId=" + locationId + ", hospitalId=" + hospitalId + ", discarded="
				+ discarded + ", dentalDiagnosticService=" + dentalDiagnosticService + "]";
	}
