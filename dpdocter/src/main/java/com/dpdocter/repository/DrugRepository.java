...
public interface DrugRepository extends MongoRepository<DrugCollection, String> {
    ...
    List<DrugCollection> getDrugs(String doctorId, Date date, boolean isDeleted, Sort sort);

    @Query("{'doctorId': ?0}")
    List<DrugCollection> getDrugs(String doctorId, Sort sort);

    @Query("{'doctorId': ?0,'isDeleted': ?1}")
    List<DrugCollection> getDrugs(String doctorId, boolean isDeleted, Sort sort);
    ...
    List<DrugCollection> getDrugs(String doctorId, String hospitalId, String locationId, Date date, boolean isDeleted, Sort sort);
    ...
    List<DrugCollection> getDrugs(String doctorId, String hospitalId, String locationId, boolean isDeleted, Sort sort);
