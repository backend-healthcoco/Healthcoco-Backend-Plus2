...
public interface PatientQueueRepository extends MongoRepository<PatientQueueCollection, String>, PagingAndSortingRepository<PatientQueueCollection, String> {
	...
	PatientQueueCollection find(String appointmentId, String doctorId, String locationId, String hospitalId, String patientId, DateTime start, DateTime end, Boolean discarded);
