...
public interface SMSTrackRepository extends MongoRepository<SMSTrackDetail, ObjectId>, PagingAndSortingRepository<SMSTrackDetail, ObjectId> {
    ...
    List<SMSTrackDetail> findByLocationHospitalId(ObjectId locationId, ObjectId hospitalId, String[] type, Pageable pageable);
    ...
    List<SMSTrackDetail> findByDoctorLocationHospitalId(ObjectId doctorId, ObjectId locationId, ObjectId hospitalId, String[] type, Pageable pageable);

    @Query("{'doctorId': ?0, 'locationId': ?1, 'hospitalId': ?2, 'type':{$in: ?3}}")
    List<SMSTrackDetail> findByDoctorLocationHospitalId(ObjectId doctorId, ObjectId locationId, ObjectId hospitalId, String[] type, Sort sort);
    ...
    List<SMSTrackDetail> findByLocationHospitalPatientId(ObjectId locationId, ObjectId hospitalId, ObjectId patientId, String[] type, Pageable pageable);

    @Query("{'locationId': ?0, 'hospitalId': ?1, 'smsDetails.userId': ?2, 'type':{$in: ?3}}")
    List<SMSTrackDetail> findByLocationHospitalPatientId(ObjectId locationId, ObjectId hospitalId, ObjectId patientId, String[] type, Sort sort);

    @Query("{'doctorId': ?0, 'locationId': ?1, 'hospitalId': ?2, 'smsDetails.userId': ?3, 'type':{$in: ?4}}")
    List<SMSTrackDetail> findByDoctorLocationHospitalPatient(ObjectId doctorId, ObjectId locationId, ObjectId hospitalId, ObjectId patientId, String[] type, Pageable pageable);

    @Query("{'doctorId': ?0, 'locationId': ?1, 'hospitalId': ?2, 'smsDetails.userId': ?3, 'type':{$in: ?4}}")
    List<SMSTrackDetail> findByDoctorLocationHospitalPatient(ObjectId doctorId, ObjectId locationId, ObjectId hospitalId, ObjectId patientId, String[] type, Sort sort);
