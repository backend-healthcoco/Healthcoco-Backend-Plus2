...
public interface ReferenceRepository extends MongoRepository<ReferencesCollection, String> {
    @Query(value = "{'$and': [ {'$or': [ {'doctorId': ?0}, {'doctorId': ''} ]}, {'$or': [ {'locationId': ?1}, {'locationId': ''} ]}, {'$or': [ {'hospitalId': ?2}, {'hospitalId': ''} ]}, {'discarded': ?3} ]}", fields = "{'doctorId': 0, 'hospitalId': 0, 'locationId': 0, 'discarded': 0}")
    ...
    @Query(value = "{'doctorId': ?0, 'locationId': ?1, 'hospitalId': ?2, 'discarded': ?3}", fields = "{'doctorId': 0, 'hospitalId': 0, 'locationId': 0, 'discarded': 0}")
