...
public interface ComplaintRepository extends MongoRepository<ComplaintCollection, ObjectId>, PagingAndSortingRepository<ComplaintCollection, ObjectId> {
    ...
    List<ComplaintCollection> findCustomComplaints(ObjectId doctorId, ObjectId locationId, ObjectId hospitalId, Date date, boolean[] discards, Pageable pageable);

    @Query("{'doctorId': ?0, 'locationId': ?1, 'hospitalId': ?2, 'updatedTime': {'$gt': ?3}, 'discarded': {$in: ?4}}")
    List<ComplaintCollection> findCustomComplaints(ObjectId doctorId, ObjectId locationId, ObjectId hospitalId, Date date, boolean[] discards, Sort sort);
    ...
    List<ComplaintCollection> findCustomGlobalComplaints(ObjectId doctorId, ObjectId locationId, ObjectId hospitalId, Collection<String> specialities, Date date, boolean[] discards, Pageable pageable);

    @Query("{'$or': [{'doctorId': ?0,  'locationId': ?1, 'hospitalId': ?2, 'speciality': {$in: ?3}, 'updatedTime': {'$gt': ?4}, 'discarded': {$in: ?5}},{'doctorId': null, 'locationId': null, 'hospitalId': null, 'speciality': {$in: ?3}, 'updatedTime': {'$gt': ?4},'discarded': {$in: ?5}}]}")
    List<ComplaintCollection> findCustomGlobalComplaints(ObjectId doctorId, ObjectId locationId, ObjectId hospitalId, Collection<String> specialities, Date date, boolean[] discards, Sort sort);

    @Query("{'doctorId': ?0, 'updatedTime': {'$gt': ?1}, 'discarded': {$in: ?2}}")
    List<ComplaintCollection> findCustomComplaints(ObjectId doctorId, Date date, boolean[] discards, Pageable pageable);

    @Query("{'doctorId': ?0, 'updatedTime': {'$gt': ?1}, 'discarded': {$in: ?2}}")
    List<ComplaintCollection> findCustomComplaints(ObjectId doctorId, Date date, boolean[] discards, Sort sort);
    ...
    List<ComplaintCollection> findCustomGlobalComplaints(ObjectId doctorId, Collection<String> specialities, Date date, boolean[] discards, Pageable pageable);

    @Query("{'$or': [{'doctorId': ?0, 'speciality': {$in: ?1}, 'updatedTime': {'$gt': ?2}, 'discarded': {$in: ?3}},{'doctorId': null, 'speciality': {$in: ?1}, 'updatedTime': {'$gt': ?2},'discarded': {$in: ?3}}]}")
    List<ComplaintCollection> findCustomGlobalComplaints(ObjectId doctorId, Collection<String> specialities, Date date, boolean[] discards, Sort sort);
