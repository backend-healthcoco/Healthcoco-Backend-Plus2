...
@Document(indexName = "present_complaints_in", type = "present_complaints")
public class ESPresentComplaintDocument {
	...
	public String toString() {
		return "ESPresentComplaintDocument [id=" + id + ", presentComplaint=" + presentComplaint + ", doctorId="
