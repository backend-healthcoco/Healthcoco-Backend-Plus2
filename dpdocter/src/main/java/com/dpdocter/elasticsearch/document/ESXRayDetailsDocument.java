...
@Document(indexName = "x_ray_details_in", type = "x_ray_details")
public class ESXRayDetailsDocument {
	...
	public String toString() {
		return "ESXRayDetailsDocument [id=" + id + ", xRayDetails=" + xRayDetails + ", doctorId=" + doctorId
