...
@Document(indexName = "system_exam_in", type = "system_exam")
public class ESSystemExamDocument {
	...
	public String toString() {
		return "ESSystemExamDocument [id=" + id + ", systemExam=" + systemExam + ", doctorId=" + doctorId
