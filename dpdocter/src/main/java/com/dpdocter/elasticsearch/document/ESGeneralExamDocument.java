...
@Document(indexName = "general_exam_in", type = "general_exam")
public class ESGeneralExamDocument {
	...
	public String toString() {
		return "ESGeneralExamDocument [id=" + id + ", generalExam=" + generalExam + ", doctorId=" + doctorId
