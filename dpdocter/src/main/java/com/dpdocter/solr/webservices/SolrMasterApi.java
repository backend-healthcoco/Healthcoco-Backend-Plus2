...
public class SolrMasterApi {
	...
	List<Reference> searchResonse = solrMasterService.searchReference(range, page, size, doctorId, locationId, hospitalId, updatedTime, discarded, searchTerm);
	...
	List<DiseaseListResponse> searchResonse = solrMasterService.searchDisease(range, page, size, doctorId, locationId, hospitalId, updatedTime, discarded, searchTerm);
    ...
    @GET
    public Response<BloodGroup> searchBloodGroup(@DefaultValue("0") @QueryParam(value = "updatedTime") String updatedTime, @QueryParam(value = "searchTerm") String searchTerm,
    ...
    @GET
    public Response<Profession> searchProfession(@QueryParam(value = "searchTerm") String searchTerm, @DefaultValue("0") @QueryParam(value = "updatedTime") String updatedTime,
    		@QueryParam("page") int page, @QueryParam("size") int size) {
    ...
    @GET
    public Response<ProfessionalMembership> searchProfessionalMembership(@QueryParam(value = "searchTerm") String searchTerm, @DefaultValue("0") @QueryParam(value = "updatedTime") String updatedTime,
    		@QueryParam("page") int page, @QueryParam("size") int size) {
    ...
    @GET
    public Response<EducationInstitute> searchEducationInstitute(@QueryParam(value = "searchTerm") String searchTerm, @DefaultValue("0") @QueryParam(value = "updatedTime") String updatedTime,
    		@QueryParam("page") int page, @QueryParam("size") int size) {
    ...
    @GET
    public Response<EducationQualification> searchEducationQualification(@QueryParam(value = "searchTerm") String searchTerm, @DefaultValue("0") @QueryParam(value = "updatedTime") String updatedTime,
    		@QueryParam("page") int page, @QueryParam("size") int size) {
    ...
    @GET
    public Response<MedicalCouncil> searchMedicalCouncil(@QueryParam(value = "searchTerm") String searchTerm, @DefaultValue("0") @QueryParam(value = "updatedTime") String updatedTime,
    		@QueryParam("page") int page, @QueryParam("size") int size) {
    ...
    @GET
    public Response<Speciality> searchSpeciality(@QueryParam(value = "searchTerm") String searchTerm, @DefaultValue("0") @QueryParam(value = "updatedTime") String updatedTime,
    		@QueryParam("page") int page, @QueryParam("size") int size) {
