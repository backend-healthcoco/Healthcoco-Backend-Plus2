...
public interface SolrObservationsRepository extends SolrCrudRepository<SolrObservationsDocument, String> {
	...
	public List<SolrObservationsDocument> findCustomGlobalObservations(Date date, Boolean discarded,
	...
	public List<SolrObservationsDocument> findCustomGlobalObservations(Date date, Boolean discarded, String searchTerm,
			Pageable pageRequest);
	...
	public List<SolrObservationsDocument> findCustomGlobalObservations(String doctorId, Date date, Boolean discarded,
			Pageable pageRequest);
	...
	public List<SolrObservationsDocument> findCustomGlobalObservations(String doctorId, String locationId,
	...
	@Query("(doctorId:*?0* AND updatedTime: {?1 TO *} AND ( discarded: ?2 OR discarded:false)  AND observation:*?3*) OR (doctorId:null AND updatedTime: {?1 TO *} AND ( discarded: ?2 OR discarded:false)  AND observation:*?3*)")
	public List<SolrObservationsDocument> findCustomGlobalObservations(String doctorId, Date date, Boolean discarded,
	...
	@Query("(doctorId:*?0* AND locationId:*?1* AND hospitalId:*?2* AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND observation:*?5*) OR (doctorId:null AND locationId:null AND hospitalId: null AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND observation:*?5*)")
	public List<SolrObservationsDocument> findCustomGlobalObservations(String doctorId, String locationId,
	...
	@Query("doctorId: null AND updatedTime: {?0 TO *} AND ( discarded: ?1 OR discarded:false) AND observation:*?2*")
	public List<SolrObservationsDocument> findGlobalObservations(Date date, Boolean discarded, String searchTerm,
			Pageable pageRequest);
	...
	public List<SolrObservationsDocument> findCustomObservations(String doctorId, Date date, Boolean discarded,
			Pageable pageRequest);
	...
	public List<SolrObservationsDocument> findCustomObservations(String doctorId, String locationId, String hospitalId,
	...
	public List<SolrObservationsDocument> findCustomObservations(String doctorId, String locationId, String hospitalId,
			Date date, String searchTerm, Boolean discarded, Pageable pageRequest);

	@Query("doctorId:*?0* AND locationId:*?1* AND hospitalId:*?2* AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND observation:*?5*")
	public List<SolrObservationsDocument> findCustomObservations(String doctorId, String locationId, String hospitalId,
			Date date, String searchTerm, Boolean discarded, Sort sort);
}
