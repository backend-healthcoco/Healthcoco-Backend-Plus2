...
public interface SolrLabTestRepository extends SolrCrudRepository<SolrLabTestDocument, String> {
	...
	List<SolrLabTestDocument> getCustomGlobalLabTests(Date date, boolean discarded, String searchTerm,
	...
	List<SolrLabTestDocument> getCustomGlobalLabTests(String doctorId, Date date, boolean discarded,
			Pageable pageRequest);
	...
	List<SolrLabTestDocument> getCustomGlobalLabTests(String doctorId, String hospitalId, String locationId, Date date,
    ...
    @Query("(doctorId:*?0* AND updatedTime: {?1 TO *} AND ( discarded: ?2 OR discarded:false) AND testName:*?3*) OR (doctorId:null AND updatedTime: {?1 TO *} AND ( discarded: ?2 OR discarded:false) AND testName:*?3*)")
	List<SolrLabTestDocument> getCustomGlobalLabTests(String doctorId, Date date, boolean discarded, String searchTerm,
			Pageable pageRequest);
    ...
    @Query("(doctorId:*?0* AND locationId:*?1* AND hospitalId:*?2* AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND testName:*?5*) OR (doctorId:null AND locationId:null AND hospitalId: null AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND testName:*?5*)")
	List<SolrLabTestDocument> getCustomGlobalLabTests(String doctorId, String hospitalId, String locationId, Date date,
    ...
    @Query("doctorId: null AND updatedTime: {?0 TO *} AND ( discarded: ?1 OR discarded:false) AND testName:*?2*")
	List<SolrLabTestDocument> getGlobalLabTests(Date date, Boolean discarded, String searchTerm,
			Pageable pageRequest);
	...
	List<SolrLabTestDocument> getCustomLabTests(String doctorId, String hospitalId, String locationId, Date date,
			boolean discarded, Pageable pageRequest);
	...
	List<SolrLabTestDocument> getCustomLabTests(String doctorId, Date date, boolean discarded, String searchTerm,
			Pageable pageRequest);
