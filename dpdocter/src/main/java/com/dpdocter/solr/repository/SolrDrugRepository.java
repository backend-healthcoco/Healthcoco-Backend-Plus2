...
public interface SolrDrugRepository extends SolrCrudRepository<SolrDrugDocument, String> {
	...
	public List<SolrDrugDocument> getCustomGlobalDrugs(Date date, boolean discarded, String searchTerm,
	...
	public List<SolrDrugDocument> getCustomGlobalDrugs(String doctorId, Date date, boolean discarded,
			Pageable pageRequest);
	...
	public List<SolrDrugDocument> getCustomGlobalDrugs(String doctorId, String hospitalId, String locationId, Date date,
    ...
    @Query("(doctorId:*?0* AND updatedTime: {?1 TO *} AND ( discarded: ?2 OR discarded:false) AND (drugName:*?3* OR description:*?3* OR drugCode:*?3*)) OR (doctorId:null AND updatedTime: {?1 TO *} AND ( discarded: ?2 OR discarded:false) AND (drugName:*?3* OR description:*?3* OR drugCode:*?3*))")
	public List<SolrDrugDocument> getCustomGlobalDrugs(String doctorId, Date date, boolean discarded, String searchTerm,
			Pageable pageRequest);
    ...
    @Query("(doctorId:*?0* AND locationId:*?1* AND hospitalId:*?2* AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND (drugName:*?5* OR description:*?5* OR drugCode:*?5*)) OR (doctorId:null AND locationId:null AND hospitalId: null AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND (drugName:*?5* OR description:*?5* OR drugCode:*?5*))")
	public List<SolrDrugDocument> getCustomGlobalDrugs(String doctorId, String hospitalId, String locationId, Date date,
    ...
    @Query("doctorId: null AND updatedTime: {?0 TO *} AND ( discarded: ?1 OR discarded:false) AND (drugName:*?2* OR description:*?2* OR drugCode:*?2*)")
	public List<SolrDrugDocument> getGlobalDrugs(Date date, boolean discarded, String searchTerm,
			Pageable pageRequest);
	...
	public List<SolrDrugDocument> getCustomDrugs(String doctorId, Date date, boolean discarded,
			Pageable pageRequest);
	...
	public List<SolrDrugDocument> getCustomDrugs(String doctorId, String hospitalId, String locationId, Date date,
			boolean discarded, Pageable pageRequest);
	...
	public List<SolrDrugDocument> getCustomDrugs(String doctorId, Date date, boolean discarded, String searchTerm,
			Pageable pageRequest);
