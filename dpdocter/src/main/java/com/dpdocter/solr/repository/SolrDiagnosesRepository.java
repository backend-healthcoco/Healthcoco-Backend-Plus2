...
public interface SolrDiagnosesRepository extends SolrCrudRepository<SolrDiagnosesDocument, String> {
	...
	public List<SolrDiagnosesDocument> findCustomGlobalDiagnosis(Date date, Boolean discarded, String searchTerm,
	...
	public List<SolrDiagnosesDocument> findCustomGlobalDiagnosis(String doctorId, Date date, Boolean discarded,
			Pageable pageRequest);
	...
	public List<SolrDiagnosesDocument> findCustomGlobalDiagnosis(String doctorId, String locationId, String hospitalId,
	...
	@Query("(doctorId:*?0* AND updatedTime: {?1 TO *} AND ( discarded: ?2 OR discarded:false)  AND diagnosis:*?3*) OR (doctorId:null AND updatedTime: {?1 TO *} AND ( discarded: ?2 OR discarded:false)  AND diagnosis:*?3*)")
	public List<SolrDiagnosesDocument> findCustomGlobalDiagnosis(String doctorId, Date date, Boolean discarded,
	...
	@Query("(doctorId:*?0* AND locationId:*?1* AND hospitalId:*?2* AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND diagnosis:*?5*) OR (doctorId:null AND locationId:null AND hospitalId: null AND updatedTime: {?3 TO *} AND ( discarded: ?4 OR discarded:false) AND diagnosis:*?5*)")
	public List<SolrDiagnosesDocument> findCustomGlobalDiagnosis(String doctorId, String locationId, String hospitalId,
	...
	@Query("doctorId: null AND updatedTime: {?0 TO *} AND ( discarded: ?1 OR discarded:false) AND diagnosis:*?2*")
	public List<SolrDiagnosesDocument> findGlobalDiagnosis(Date date, Boolean discarded, String searchTerm,
			Pageable pageRequest);
	...
	public List<SolrDiagnosesDocument> findCustomDiagnosis(String doctorId, Date date, Boolean discarded,
			Pageable pageRequest);
	...
	public List<SolrDiagnosesDocument> findCustomDiagnosis(String doctorId, String locationId, String hospitalId,
			Date date, Boolean discarded, Pageable pageRequest);
