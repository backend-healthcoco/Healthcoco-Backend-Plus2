...
public class CollectionBoyDoctorAssociation extends GenericCollection {
	...
	public String toString() {
		return "CollectionBoyDoctorAssociation [id=" + id + ", collectionBoyId=" + collectionBoyId + ", dentalLabId="
