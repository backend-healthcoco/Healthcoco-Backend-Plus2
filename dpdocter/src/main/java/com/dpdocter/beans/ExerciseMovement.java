...
public class ExerciseMovement extends GenericCollection {
	private String id;
	...
	public String toString() {
		return "ExerciseMovement [id=" + id + ", doctorId=" + doctorId + ", locationId=" + locationId + ", hospitalId="
				+ hospitalId + ", patientId=" + patientId + ", discarded=" + discarded + ", exerciseAndMovementBoolen="
				+ exerciseAndMovementBoolen + ", exerciseAndMovementString=" + exerciseAndMovementString
				+ ", exerciseAndMovementList=" + exerciseAndMovementList
