...
public class ClinicAddress {
	...
	public String toString() {
		return "ClinicAddress [id=" + id + ", locationName=" + locationName + ", streetAddress=" + streetAddress
				...
				+ ", postalCode=" + postalCode + ", mobileNumber=" + mobileNumber + ", locationPhoneNumber="
				+ locationPhoneNumber + ", alternateNumbers=" + alternateNumbers + ", landmarkDetails=" + landmarkDetails
