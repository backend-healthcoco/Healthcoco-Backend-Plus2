...
public class Appointment extends GenericCollection{
	...
	public String toString() {
		return "Appointment [id=" + id + ", time=" + time + ", patientId=" + patientId + ", isConfirmed=" + isConfirmed
				+ ", isCanceled=" + isCanceled + ", isReschduled=" + isReschduled + ", date=" + date + ", day=" + day
				+ ", week=" + week + ", month=" + month + ", appointmentId=" + appointmentId + ", isEvent=" + isEvent
