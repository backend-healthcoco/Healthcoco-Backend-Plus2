...
public class DentalImagingInvoice {
	...
	public String toString() {
		return "DentalImagingInvoice [id=" + id + ", dentalImagingId=" + dentalImagingId + ", doctorId=" + doctorId
				+ ", locationId=" + locationId + ", hospitalId=" + hospitalId + ", patientId=" + patientId
				+ ", patientName=" + patientName + ", mobileNumber=" + mobileNumber + ", dentalImagingLocationId="
				+ dentalImagingLocationId + ", dentalImagingHospitalId=" + dentalImagingHospitalId
				+ ", uniqueInvoiceId=" + uniqueInvoiceId + ", totalDiscount=" + totalDiscount + ", totalCost="
