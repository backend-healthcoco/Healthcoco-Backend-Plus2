...
import com.dpdocter.beans.DataEncryptionResponse;
	...
	public class DhCryptoHiu {
	   ...
	   String     strToPerformActionOn1="{\n" + 
	        ...
	        String senderPublicKey2 =keypair;
	        
	        byte[] publicBytes = Base64.decode(senderPublicKey2);
	        ...
	        String senderPublicKey = getBase64String(getEncodedPublicKey(pubKey));
	       ...
	       // String encryptedData = encrypt(xorOfRandom, senderPrivateKey1, receiverPublicKey, strToPerformActionOn);
	        ...
	        String decryptedData = decrypt(xorOfRandom, receiverPrivateKey, senderPublicKey, strToPerformActionOn);
