...
public class HistoryCollection {
	...
	public List<String> getSpetialNotes() {
		return spetialNotes;
	}
	public void setSpetialNotes(List<String> spetialNotes) {
		this.spetialNotes = spetialNotes;
	}
	
	@Override
	public String toString() {
		return "HistoryCollection [id=" + id + ", doctorId=" + doctorId
				...
				+ ", medicalhistory=" + medicalhistory + ", spetialNotes="
				+ spetialNotes + "]";
	}
