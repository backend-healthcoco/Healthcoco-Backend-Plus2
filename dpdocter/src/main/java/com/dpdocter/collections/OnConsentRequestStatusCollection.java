...
import com.dpdocter.beans.ConsentRequest;
import com.dpdocter.beans.FetchResponse;
import com.dpdocter.beans.NdhmErrorObject;

@Document(collection = "consent_request_status_cl")
public class OnConsentRequestStatusCollection extends GenericCollection{
	@Id
	private ObjectId id;
	@Field
