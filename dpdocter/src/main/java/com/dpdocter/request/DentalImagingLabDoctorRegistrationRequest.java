...
public class DentalImagingLabDoctorRegistrationRequest {
	...
	public String toString() {
		return "DentalImagingLabDoctorRegistrationRequest [title=" + title + ", firstName=" + firstName + ", password="
				...
				+ streetAddress + ", registerNumber=" + registerNumber + ", dentalImagingLocationId="
