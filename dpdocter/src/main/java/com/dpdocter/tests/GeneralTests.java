...
//	    		model.put("imageURL", "https://s3.amazonaws.com/healthcoco/templatesImage/");
//	    		String body = "njsnnmsnmnms";//VelocityEngineUtils.mergeTemplateIntoString(velocityEngine, "mailTemplate.vm", "UTF-8", model);
//	    		
...
//	    		System.out.println(ImageIO.read(new File("s3.amazonaws.com/healthcoco/profile-image/11Wed Dec 23 11_49_27 UTC 2015REPORTS1455775916464.jpeg")));
    }
}  	
