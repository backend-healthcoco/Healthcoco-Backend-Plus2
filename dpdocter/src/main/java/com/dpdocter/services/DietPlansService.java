...
public interface DietPlansService {
	...
	public Response<DietPlanTemplate> getDietPlanTemplates(int page, int size, String doctorId, String hospitalId, String locationId,
			...
			String community, String type, String pregnancyCategory, String searchTerm, String foodPreference, List<String> disease, Double bmiFrom, Double bmiTo, String languageId, Double age, Double bmi);
