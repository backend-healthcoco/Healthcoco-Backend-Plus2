...
public class SmsUtilsServiceImpl implements SmsUtilService {
	...
	/**
	 * Determines the necessary encoding based upon the characters in the message
	 * and the number of parts the sms needs to be split into
	 *
	...
	public int getNumberOfPartsFor7BitEncoding(String content) {
		...
		// number of parts if we don't consider that a message part cannot just end with
		// GSM0338Charset.ESCAPE_CHAR
		...
		// if we have enough left characters in a message part, check if it would fill a
		// worst case scenario
		...
		// There are characters left, don't care about escape character at the end of
		// multiparts
	...
	/**
	 * Escape any characters from the GSM0338Charset which belong to the extended
	 * charset
	 *
	 * @param message message
	 * @return new String with escaped characters
	 * @throws IllegalArgumentException when the message contains characters outside
	 *                                  the GSM0338Charset
	 */
	...
	/**
	 * Split the SMS into as many parts as necessary according to the determined
	 * encoding
	 *
	 * @param message message
	 * @return Pair&lt;Encoding, List &lt;String&gt;&gt; the encoding and the list
	 *         of parts the sms has been split into
	 */
