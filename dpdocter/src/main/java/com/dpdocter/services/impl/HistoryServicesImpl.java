...
public class HistoryServicesImpl implements HistoryServices {
	...
	@Override
	public boolean addReportToHistory(String reportId, String patientId,
			String doctorId, String hospitalId, String locationId) {
	...
	@Override
	public boolean addClinicalNotesToHistory(String clinicalNotesId, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			//check if history for this patient is already added .
		 historyCollection = historyRepository.findByDoctorIdLocationIdHospitalIdAndPatientId(doctorId, locationId, hospitalId, patientId);
			if(historyCollection != null){
				...
				if(clinicalNotes != null){
					//check if this clinicalNotes id is already added into history.
	...
	@Override
	public boolean addPrescriptionToHistory(String prescriptionId, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			//check if history for this patient is already added .
		 historyCollection = historyRepository.findByDoctorIdLocationIdHospitalIdAndPatientId(doctorId, locationId, hospitalId, patientId);
			if(historyCollection != null){
				...
				if(prescriptions != null){
					//check if this prescription id is already added into history.
	...
	@Override
	public boolean assignMedicalHistory(String diseaseId, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			//check if history for this patient is already added .
	...
	@Override
	public boolean assignFamilyHistory(String diseaseId, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			//check if history for this patient is already added .
	...
	@Override
	public boolean addSpetialNotes(List<String> spetialNotes, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			//check if history for this patient is already added .
		 historyCollection = historyRepository.findByDoctorIdLocationIdHospitalIdAndPatientId(doctorId, locationId, hospitalId, patientId);
			if(historyCollection != null){
				...
				if(spetialNotesInHistory != null){
					spetialNotesInHistory.addAll(spetialNotes);
				...
				historyCollection = new HistoryCollection(doctorId, locationId, hospitalId, patientId);
				historyCollection.setSpetialNotes(spetialNotes);
			}
			//finally add history into db.
			historyRepository.save(historyCollection);
		} catch (Exception e) {
	...
	@Override
	public boolean removeReports(String reportId, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			 historyCollection = historyRepository.findByDoctorIdLocationIdHospitalIdAndPatientId(doctorId, locationId, hospitalId, patientId);
	...
	@Override
	public boolean removeClinicalNotes(String clinicalNotesId,
	...
	@Override
	public boolean removePrescription(String prescriptionId, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			 historyCollection = historyRepository.findByDoctorIdLocationIdHospitalIdAndPatientId(doctorId, locationId, hospitalId, patientId);
	...
	@Override
	public boolean removeMedicalHistory(String diseaseId, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			 historyCollection = historyRepository.findByDoctorIdLocationIdHospitalIdAndPatientId(doctorId, locationId, hospitalId, patientId);
	...
	@Override
	public boolean removeFamilyHistory(String diseaseId, String patientId,
			String doctorId, String hospitalId, String locationId) {
		HistoryCollection historyCollection = null;
		try {
			 historyCollection = historyRepository.findByDoctorIdLocationIdHospitalIdAndPatientId(doctorId, locationId, hospitalId, patientId);
	...
	private boolean checkIfHistoryRemovedCompletly(HistoryCollection historyCollection){
		if(historyCollection != null){
			if(historyCollection.getReports() == null && historyCollection.getClinicalNotes() == null 
					&& historyCollection.getPrescriptions() == null && historyCollection.getMedicalhistory() == null
					&& historyCollection.getFamilyhistory() == null && historyCollection.getSpetialNotes() == null){
				return true;
			}else{
				return false;
			}
	...
	@Override
	public List<DiseaseListResponse> getDiseases(String doctorId,
			...
			if(diseaseCollections != null){
				...
				for(DiseasesCollection diseasesCollection : diseaseCollections){
					DiseaseListResponse diseaseListResponse = new DiseaseListResponse(diseasesCollection.getId(),
							diseasesCollection.getDisease(), diseasesCollection.getDescription());
