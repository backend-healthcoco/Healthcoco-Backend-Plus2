			...
			if (userDeviceCollections != null && !userDeviceCollections.isEmpty()) {
				for (UserDeviceCollection userDeviceCollection : userDeviceCollections) {
					if (userDeviceCollection.getDeviceType() != null) {
						...
						if(componentType.equalsIgnoreCase(ComponentType.SIGNED_UP.getType()))
						{
							message="New Doctor has been signed up successfully.";
							userDeviceCollections=userDeviceRepository.findByDeviceType(DeviceType.WEB_ADMIN.getType());
							...
							|| userDeviceCollection.getDeviceType().getType()
								...
								userDeviceCollection.getPushToken(), message, ComponentType.SIGNED_UP.getType(), componentTypeId,
								userDeviceCollection.getDeviceType().getType(),
