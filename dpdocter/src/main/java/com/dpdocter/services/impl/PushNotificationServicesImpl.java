...
public class PushNotificationServicesImpl implements PushNotificationServices {
	...
	@Value("${ios.certificate.pushNotifyCall.password.patientApp}")
	private String iosCertificatePushNotifyPasswordPatientApp;

	@Value("${ios.certificate.pushNotifyCall.filename.patientApp}")
	private String iosCertificatePushNotifyFileNamePatientApp;
