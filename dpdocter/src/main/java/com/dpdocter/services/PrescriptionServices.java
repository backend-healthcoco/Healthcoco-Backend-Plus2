...
public interface PrescriptionServices {
	...
	TemplateAddEditResponseDetails deleteTemplate(String templateId, String doctorId, String hospitalId,
	...
	PrescriptionTestAndRecord checkPrescriptionExists(String uniqueEmrId, String patientId, String locationId, String hospitalId);
	...
	List<Instructions> getInstructions(long page, int size, String doctorId, String locationId, String hospitalId,
