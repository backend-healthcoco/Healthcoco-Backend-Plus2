...
//import javax.w0s.rs.PathParam;
//import javax00.ws.rs.Produces;
...
//	public Response<OrthoProgressResponse> getOrthoProgressById(@PathParam(value = "id") String id) {
//		OrthoProgressResponse clinicalNotes = orthoService.getOrthoProgressById(id);
...
//	public Response<OrthoProgressResponse> editOrthoProgressDetailsDates(OrthoEditProgressDatesRequest request) {
//		if (request == null || DPDoctorUtils.anyStringEmpty(request.getProgressId())) {
//			logger.warn("Invalid Input");
//			throw new BusinessException(ServiceError.InvalidInput, "Invalid Input");
//		}
//
//		OrthoProgressResponse orthoResponse = orthoService.editOrthoProgressDetailsDates(request);
//
//		Response<OrthoProgressResponse> response = new Response<OrthoProgressResponse>();
//		response.setData(orthoResponse);
//		return response;
