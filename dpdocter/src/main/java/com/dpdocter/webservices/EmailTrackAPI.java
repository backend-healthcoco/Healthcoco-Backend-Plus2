...
public class EmailTrackAPI {
	...
	@GET
	public Response<EmailTrack> getEmailDetails(@QueryParam(value = "doctorId") String doctorId,@QueryParam(value = "locationId") String locationId, @QueryParam(value = "hospitalId") String hospitalId,
