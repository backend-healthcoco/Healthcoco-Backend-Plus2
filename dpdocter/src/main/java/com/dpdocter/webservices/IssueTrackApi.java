...
public class IssueTrackApi {
	...
	public Response<IssueTrack> deleteIssue(@PathParam(value = "issueId") String issueId,
	...
	public Response<IssueTrack> getIssues(@QueryParam("page") long page, @QueryParam("size") int size,
		...
		List<IssueTrack> issueTrack = issueTrackService.getIssues(page, size, doctorId, locationId, hospitalId,
				updatedTime, discarded != null ? discarded : true, scope);
		Response<IssueTrack> response = new Response<IssueTrack>();
	...
	public Response<Boolean> updateIssueStatus(@PathParam("issueId") String issueId,
