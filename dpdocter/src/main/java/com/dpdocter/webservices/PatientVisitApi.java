...
public class PatientVisitApi {
	...
	if (request == null || DPDoctorUtils.allStringsEmpty(request.getDoctorId(), request.getLocationId(), request.getHospitalId(), request.getPatientId())) {
    ...
    public Response<PatientVisitResponse> getVisit(@PathParam(value = "doctorId") String doctorId, @PathParam(value = "locationId") String locationId,
	    ...
	    @QueryParam(value = "size") int size, @DefaultValue("0") @QueryParam("updatedTime") String updatedTime,@QueryParam("visitFor") String visitFor) {
	...
	List<PatientVisitResponse> patienVisitResponse = patientVisitService.getVisit(doctorId, locationId, hospitalId, patientId, page, size, otpService.checkOTPVerified(doctorId, locationId, hospitalId, patientId), updatedTime, visitFor);
	...
	PatientVisit patienVisitResponse = patientVisitService.deleteVisit(visitId, discarded);
    ...
    public Response<String> downloadPatientVisit(@PathParam("visitId") String visitId, @DefaultValue("false") @QueryParam("showPH") Boolean showPH,
    		...
    		@DefaultValue("false") @QueryParam("showLMP") Boolean showLMP, @DefaultValue("false") @QueryParam("showEDD") Boolean showEDD,
    	...
    	response.setData(patientVisitService.getPatientVisitFile(visitId, showPH, showPLH, showFH, showDA, showUSG, isLabPrint, isCustomPDF, showLMP,
