...
//	}
    ...
    @Path(value = PathProxy.AdminUrls.ADD_EDIT_GENERIC_CODE)
    @POST
    ...
    @Path(value = PathProxy.AdminUrls.ADD_REMOVE_GENERIC_CODE_TO_DRUG)
    @GET
    @ApiOperation(value = PathProxy.AdminUrls.ADD_REMOVE_GENERIC_CODE_TO_DRUG, notes = PathProxy.AdminUrls.ADD_REMOVE_GENERIC_CODE_TO_DRUG)
