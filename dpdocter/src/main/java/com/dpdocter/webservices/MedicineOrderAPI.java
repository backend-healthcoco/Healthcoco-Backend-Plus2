...
public class MedicineOrderAPI {
	...
	public Response<MedicineOrder> getPatientOrderList(@PathParam(value = "patientId") String patientId,
			@DefaultValue("0") @QueryParam(value = "updatedTime") String updatedTime,
			@QueryParam(value = "searchTerm") String searchTerm, @QueryParam(value = "page") int page,
			@QueryParam(value = "size") int size, @MatrixParam(value = "status") List<String> status) {

		if (DPDoctorUtils.allStringsEmpty(patientId)) {
			throw new BusinessException(ServiceError.InvalidInput, "Invalid input. Id cannot be null");
		}

		List<MedicineOrder> medicineOrders = medicineOrderService.getOrderList(patientId, updatedTime, searchTerm, page,
				size, status);
		Response<MedicineOrder> response = new Response<MedicineOrder>();
	...
	public Response<DrugInfo> getGetDrugInfoList(@QueryParam("page") int page, @QueryParam("size") int size,
	...
	public Response<TrackingOrder> getTrackingDetailsByOrder(@PathParam("orderId") String orderId,
		...
		List<TrackingOrder> trackingOrders = medicineOrderService.getTrackingList(orderId, updatedTime, searchTerm,
				page, size);
		Response<TrackingOrder> response = new Response<TrackingOrder>();
