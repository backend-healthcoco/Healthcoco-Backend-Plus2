...
public class AppointmentApi {
	...
	public Response<Lab> getLabs(@PathParam("locationId") String locationId, @QueryParam("patientId") String patientId, @DefaultValue("false") @QueryParam(value = "active") Boolean active)
