...
public class AppointmentApi {
    ...
    public Response<City> addCity(City request) {
		...
		if(request.getId() == null){ solrCityService.addCities(solrCities);	}
		
		else{ solrCityService.editCities(solrCities);}
    ...
    public Response<Locality> addLocality(Locality request) {
		...
		if(request.getId() == null){ solrCityService.addLocalityLandmark(solrLocalityLandmark);	}
		
		else{ solrCityService.editLocalityLandmark(solrLocalityLandmark);}
