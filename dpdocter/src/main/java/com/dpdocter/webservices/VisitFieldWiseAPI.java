...
public class VisitFieldWiseAPI {
	...
	public Response<Object> getAdmitCardData(@PathParam(value = "patientId") String patientId,
		...
		Response<Object> response = visitfieldWiseService.getAdmitCardData(doctorId, locationId, hospitalId, patientId,
				type);
	...
	public Response<Object> getOperationNotesData(@PathParam(value = "patientId") String patientId,
		...
		Response<Object> response = visitfieldWiseService.getOperationNotesData(doctorId, locationId, hospitalId,
				patientId, type);
