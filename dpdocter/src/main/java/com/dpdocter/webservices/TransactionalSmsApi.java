...
public class TransactionalSmsApi {
	...
	public Response<MessageResponse> getTransactionSmsReport(@DefaultValue("0") @QueryParam(value = "size") int size,
			@DefaultValue("0") @QueryParam(value = "page") int page, @QueryParam("fromDate") String fromDate,
			@QueryParam("toDate") String toDate, @QueryParam(value = "doctorId") String doctorId,
