...
public class ReflectionUtil {
	...
	public static void iterateAnnotation(final Object o, final Class<?> annoClass,
			final AnnotationFoundCallback callback) throws Exception {
	...
	public static Method getMethod(Class<? extends Object> clazz, final String methodName,
	...
	public static Method getSetter(Class<? extends Object> clazz, final String fieldName, final Class<?> fieldType)
			throws Exception {
	...
	public static Method getGetter(Class<? extends Object> clazz, final String fieldName, final Class<?> fieldType)
			throws Exception {
