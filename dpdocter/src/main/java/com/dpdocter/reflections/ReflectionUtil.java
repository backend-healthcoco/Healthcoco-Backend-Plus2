...
public class ReflectionUtil {
    ...
    public static void iterateAnnotation(final Object o, final Class<?> annoClass, final AnnotationFoundCallback callback) throws Exception {
	iterateAnnotatedFields(o, annoClass, callback);
	iterateAnnotatedMethods(o, annoClass, callback);
    }

    public static void iterateAnnotatedFields(final Object o, final Class<?> annoClass, final AnnotatedFieldCallback callback) throws Exception {
	iterateAnnotatedFields(o.getClass(), o, annoClass, callback);
    }

    public static void iterateAnnotatedMethods(final Object o, final Class<?> annoClass, final AnnotatedMethodCallback callback) throws Exception {
