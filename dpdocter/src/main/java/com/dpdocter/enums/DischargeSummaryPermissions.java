...
public enum DischargeSummaryPermissions {
	...
	BED_LOG("BED_LOG"), HOSPITAL_COURSE("HOSPITAL_COURSE"),DURATION_TIME_OF_SURGERY("DURATION_TIME_OF_SURGERY"),
	ASSISTANT_DOCTORS("ASSISTANT_DOCTORS"),ASSISTANT_NURSES("ASSISTANT_NURSES"),MATERIAL_FOR_HPE("MATERIAL_FOR_HPE"),
