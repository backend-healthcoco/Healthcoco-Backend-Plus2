...
public enum ComponentType {
	...
	MULTIPLE_RECEIPT("MULTIPLE_RECEIPT"), DENTAL_WORKS_CANCELLATION("DENTAL_WORKS_CANCELLATION"), DENTAL_WORK_REFRESH("DENTAL_WORK_REFRESH") , PATIENT_CARD("PATIENT_CARD");
