...
public enum ComponentType {
	...
	RECEIPT_REFRESH("RECEIPT_REFRESH"), INVOICE_REFRESH("INVOICE_REFRESH"), RECORDS_REFRESH("RECORDS_REFRESH"), TREATMENTS_REFRESH("TREATMENTS_REFRESH") ,PROCEDURE_SHEET("PROCEDURE_SHEET");
