...
public enum ComponentType {
	...
	DENTAL_LAB_INSPECTION_REPORT("DENTAL_LAB_INSPECTION_REPORT"), REFRESH_DOCTOR_LAB_REPORTS(
			"REFRESH_DOCTOR_LAB_REPORTS"), DENTAL_WORKS("DENTAL_WORKS"), DENTAL_LAB_REQUEST("DENTAL_LAB_REQUEST"), DENTAL_WORKS_CANCELLATION("DENTAL_WORKS_CANCELLATION"),DENTAL_WORK_REFRESH("DENTAL_WORK_REFRESH");
