...
public enum Resource {
	...
	SYMPTOM_DISEASE_CONDITION("SYMPTOM_DISEASE_CONDITION"),MEDICAL_COUNCIL("MEDICAL_COUNCIL"), FITNESS_ASSESMENT("FITNESS_ASSESMENT"), NURSING_CAREEXAM("NURSING_CAREEXAM");
