...
public enum Resource {
	COMPLAINT("COMPLAINT"), OBSERVATION("OBSERVATION"), INVESTIGATION("INVESTIGATION"), DIAGNOSIS("DIAGNOSIS"), NOTES(
			"NOTES"), DIAGRAM("DIAGRAM"), PATIENT("PATIENT"), DRUG("DRUG"), LABTEST("LABTEST"), COUNTRY(
					"COUNTRY"), STATE("STATE"), CITY("CITY"), LANDMARKLOCALITY("LANDMARKLOCALITY"), DOCTOR(
							"DOCTOR"), LOCATION("LOCATION"), DIAGNOSTICTEST(
									"DIAGNOSTICTEST"), REFERENCE("REFERENCE"), DISEASE(
											"DISEASE"), TREATMENTSERVICE("TREATMENTSERVICE"), TREATMENTSERVICECOST(
	...
	PC_NOSE("PC_NOSE"),PC_EARS("PC_EARS"),PC_THROAT("PC_THROAT"),PC_ORAL_CAVITY("PC_ORAL_CAVITY"),NOSE_EXAM("NOSE_EXAM"),NECK_EXAM("NECK_EXAM"),EARS_EXAM("EARS_EXAM"),ORAL_CAVITY_THROAT_EXAM("ORAL_CAVITY_THROAT_EXAM"),INDIRECT_LARYGOSCOPY_EXAM("INDIRECT_LARYGOSCOPY_EXAM");
