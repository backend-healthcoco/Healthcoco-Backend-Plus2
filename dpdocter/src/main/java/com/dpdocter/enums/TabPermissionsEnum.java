...
public enum TabPermissionsEnum {
	...
	DELIVERY_REPORT("DELIVERY_REPORT"), DENTAL_IMAGING_REPORT("DENTAL_IMAGING_REPORT"), LAB_REPORTS("LAB_REPORTS"),
	VACCINATION("VACCINATION"), CONSENT_FORM("CONSENT_FORM"), IPD_NOTE("IPD_NOTE"),
	PRE_OPERATION_ASSESSMENT("PRE_OPERATION_ASSESSMENT"), INITIAL_ASSESSMENT("INITIAL_ASSESSMENT"),
	NURSE_ADMISSION("NURSE_ADMISSION"),ORTHO("ORTHO");
