...
public enum UniqueIdInitial {
	...
	PHARMACY_RESPONSE("PHRS"), LAB_PICKUP_REQUEST("LPR"),DENTAL_LAB_PICKUP_REQUEST("DLPR"), LAB_PICKUP_SAMPLE("LPS"), COLLECTION_BOYS("CB"), ADMIT_CARD(
			"AC"),
	ORDER_DIAGNOSTIC_TEST("ODT"), OT_REPORTS("OT"), DELIVERY_REPORTS("DR");
